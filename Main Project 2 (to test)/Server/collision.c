...
void give_next_color(GameState *gamestate, int i)
{
	//int player = which_player(gamestate);

	if (i == 0 && gamestate->players[1].lives != 0 && !gamestate->players[1].quit)
	{
		gamestate->ball.redShade = gamestate->players[1].redShade;
		gamestate->ball.greenShade = gamestate->players[1].greenShade;
		gamestate->ball.blueShade = gamestate->players[1].blueShade;
	}
	else if (i == 0 && gamestate->players[2].lives != 0 && !gamestate->players[2].quit)
	{
		gamestate->ball.redShade = gamestate->players[2].redShade;
		gamestate->ball.greenShade = gamestate->players[2].greenShade;
		gamestate->ball.blueShade = gamestate->players[2].blueShade;
	}
	else if (i == 1 && gamestate->players[2].lives != 0 && !gamestate->players[2].quit)
	{
		gamestate->ball.redShade = gamestate->players[2].redShade;
		gamestate->ball.greenShade = gamestate->players[2].greenShade;
		gamestate->ball.blueShade = gamestate->players[2].blueShade;
	}
	else if (i == 1 && gamestate->players[0].lives != 0 && !gamestate->players[0].quit)
	{
		gamestate->ball.redShade = gamestate->players[0].redShade;
		gamestate->ball.greenShade = gamestate->players[0].greenShade;
		gamestate->ball.blueShade = gamestate->players[0].blueShade;
	}
	else if (i == 2 && gamestate->players[0].lives != 0 && !gamestate->players[0].quit)
	{
		gamestate->ball.redShade = gamestate->players[0].redShade;
		gamestate->ball.greenShade = gamestate->players[0].greenShade;
		gamestate->ball.blueShade = gamestate->players[0].blueShade;
	}
	else if (i == 2 && gamestate->players[1].lives != 0 && !gamestate->players[1].quit)
	{
		gamestate->ball.redShade = gamestate->players[1].redShade;
		gamestate->ball.greenShade = gamestate->players[1].greenShade;
		gamestate->ball.blueShade = gamestate->players[1].blueShade;
