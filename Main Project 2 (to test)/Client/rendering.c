...
void doRender(SDL_Renderer *renderer, GameState *gamestate, Paddle *mypaddle, SDL_Texture *board, SDL_Texture *text, SDL_Texture *player1Texture, SDL_Texture *player2Texture, SDL_Texture *player3Texture, SDL_Texture *backgroundTexture, OldLives *oldLives) {
	int i = 0;
	...
	SDL_Rect background = { WINDOW_WIDTH / 2 -725, WINDOW_HEIGHT / 2 -725,1450,1450 };
	SDL_RenderCopyEx(renderer, backgroundTexture, NULL, &background, oldLives->angel, NULL, 0);
