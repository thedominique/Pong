	...
	if (gamestate->ball.x >= WINDOW_WIDTH / 2 + WINDOW_WIDTH / 4 - gamestate->ball.h)
	{
		...
		if (gamestate->players[which_player(gamestate)].lives != 0)
		{
			...
			if (gamestate->players[which_player(gamestate)].lives == 0)
			{
				...
				gamestate->players[which_player(gamestate)].x = 0;
				gamestate->players[which_player(gamestate)].y = 0;
				gamestate->players[which_player(gamestate)].w = 0;
				gamestate->players[which_player(gamestate)].h = 0;
			}
		}
